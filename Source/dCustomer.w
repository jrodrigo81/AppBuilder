...
&Scoped-Define DATA-FIELD-DEFS "Source/dCustomer.i"
&Scoped-Define DATA-TABLE-NO-UNDO NO-UNDO
&Scoped-define QUERY-STRING-Query-Main FOR EACH Customer NO-LOCK INDEXED-REPOSITION
{&DB-REQUIRED-START}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Customer NO-LOCK INDEXED-REPOSITION.
{&DB-REQUIRED-END}
...
"Address" "Address" ? ? "character" ? ? ? ? ? ? yes ? no 35 yes ?
     _FldNameList[2]   > sports2020.Customer.Address2
"Address2" "Address2" ? ? "character" ? ? ? ? ? ? yes ? no 35 yes ?
     _FldNameList[3]   > sports2020.Customer.Balance
"Balance" "Balance" ? ? "decimal" ? ? ? ? ? ? yes ? no 13.2 yes ?
     _FldNameList[4]   > sports2020.Customer.City
"City" "City" ? ? "character" ? ? ? ? ? ? yes ? no 25 yes ?
     _FldNameList[5]   > sports2020.Customer.Comments
"Comments" "Comments" ? ? "character" ? ? ? ? ? ? yes ? no 80 yes ?
     _FldNameList[6]   > sports2020.Customer.Contact
"Contact" "Contact" ? ? "character" ? ? ? ? ? ? yes ? no 30 yes ?
     _FldNameList[7]   > sports2020.Customer.Country
"Country" "Country" ? ? "character" ? ? ? ? ? ? yes ? no 20 yes ?
     _FldNameList[8]   > sports2020.Customer.CreditLimit
"CreditLimit" "CreditLimit" ? ? "decimal" ? ? ? ? ? ? yes ? no 10.2 yes ?
     _FldNameList[9]   > sports2020.Customer.CustNum
"CustNum" "CustNum" ? ? "integer" ? ? ? ? ? ? yes ? no 9.2 yes ?
     _FldNameList[10]   > sports2020.Customer.Discount
"Discount" "Discount" ? ? "integer" ? ? ? ? ? ? yes ? no 8.4 yes ?
     _FldNameList[11]   > sports2020.Customer.EmailAddress
"EmailAddress" "EmailAddress" ? ? "character" ? ? ? ? ? ? yes ? no 50 yes ?
     _FldNameList[12]   > sports2020.Customer.Fax
"Fax" "Fax" ? ? "character" ? ? ? ? ? ? yes ? no 20 yes ?
     _FldNameList[13]   > sports2020.Customer.Name
"Name" "Name" ? ? "character" ? ? ? ? ? ? yes ? no 30 yes ?
     _FldNameList[14]   > sports2020.Customer.Phone
"Phone" "Phone" ? ? "character" ? ? ? ? ? ? yes ? no 20 yes ?
     _FldNameList[15]   > sports2020.Customer.PostalCode
"PostalCode" "PostalCode" ? ? "character" ? ? ? ? ? ? yes ? no 11.4 yes ?
     _FldNameList[16]   > sports2020.Customer.SalesRep
"SalesRep" "SalesRep" ? ? "character" ? ? ? ? ? ? yes ? no 9.8 yes ?
     _FldNameList[17]   > sports2020.Customer.State
"State" "State" ? ? "character" ? ? ? ? ? ? yes ? no 20 yes ?
     _FldNameList[18]   > sports2020.Customer.Terms
