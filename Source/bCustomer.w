...
&Scoped-define FIELDS-IN-QUERY-br_table CustNum Name Contact Country State ~
City 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTable _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      CustNum FORMAT ">>>>9":U
      Name FORMAT "x(30)":U
      Contact FORMAT "x(30)":U
      Country FORMAT "x(20)":U
      State FORMAT "x(20)":U
      City FORMAT "x(25)":U WIDTH 23.4
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 142 BY 19.76 FIT-LAST-COLUMN.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.CustNum
     _FldNameList[2]   = _<SDO>.rowObject.Name
     _FldNameList[3]   = _<SDO>.rowObject.Contact
     _FldNameList[4]   = _<SDO>.rowObject.Country
     _FldNameList[5]   = _<SDO>.rowObject.State
     _FldNameList[6]   > _<SDO>.rowObject.City
"City" ? ? "character" ? ? ? ? ? ? no ? no no "23.4" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
