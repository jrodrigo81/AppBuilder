...
&Scoped-define FIELDS-IN-QUERY-br_table EmpNum FirstName LastName BirthDate ~
State City WorkPhone 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTable _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      EmpNum FORMAT "zzzzzzzzz9":U
      FirstName FORMAT "x(15)":U
      LastName FORMAT "x(25)":U
      BirthDate FORMAT "99/99/9999":U
      State FORMAT "x(20)":U
      City FORMAT "x(25)":U
      WorkPhone FORMAT "x(20)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 162 BY 11.19 FIT-LAST-COLUMN.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.EmpNum
     _FldNameList[2]   = _<SDO>.rowObject.FirstName
     _FldNameList[3]   = _<SDO>.rowObject.LastName
     _FldNameList[4]   = _<SDO>.rowObject.BirthDate
     _FldNameList[5]   = _<SDO>.rowObject.State
     _FldNameList[6]   = _<SDO>.rowObject.City
     _FldNameList[7]   > _<SDO>.rowObject.WorkPhone
"WorkPhone" ? ? "character" ? ? ? ? ? ? no ? no no "45.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
